...
- [Authentication](/api-reference/common/authentication)
- [Error Handling](/api-reference/common/error-handling)
- [Rate Limiting](/api-reference/common/rate-limiting)
- [Schemas](/api-reference/common/schemas)
